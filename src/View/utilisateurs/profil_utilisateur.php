...
$repo = new VehiculesRepository(Database::getConnection());
$marques = $repo->getAllMarques(); // récupère un tableau de toutes les marques
...
$message = '';    // Contiendra le message de retour (succès ou erreur)
    // Tableau vide pour stocker les marques (si besoin plus tard)
