...
class Covoiturage
{
    ...
    public function setModePaiement(?string $mode): void { $this->transaction?->setType($mode); }
    public function getVilleDepartNom(): ?string { return $this->ville_depart_nom; }
    public function setVilleDepartNom(?string $ville): void { $this->ville_depart_nom = $ville; }
    public function getVilleArriveeNom(): ?string { return $this->ville_arrivee_nom; }
    public function setVilleArriveeNom(?string $ville): void { $this->ville_arrivee_nom = $ville; }
